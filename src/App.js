...
function App() {
  return (
    ...
    /////////////Bai 2 //////////////////////////////
     <div>
        {arrBai2.map((iteam,index)=>{
          return <Bai2 key = {index} products = {iteam} ></Bai2>
        })}
     </div>
  );
}
